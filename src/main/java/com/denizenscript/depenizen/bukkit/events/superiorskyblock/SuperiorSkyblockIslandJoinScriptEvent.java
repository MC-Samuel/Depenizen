...
public class SuperiorSkyblockIslandJoinScriptEvent extends BukkitScriptEvent implements Listener {

    // <--[event]
    // @Events
    // superiorskyblock player joins island
    //
    // @Triggers when a player joins a SuperiorSkyblock island
    //
    // @Cancellable true
    //
    // @Context
    ...
    public SuperiorSkyblockIslandJoinScriptEvent() {
        registerCouldMatcher("superiorskyblock player joins island");
    }

    public IslandJoinEvent event;
